...
<title>customLogin.jsp소스코딩</title>
                        ...
                        <form role="form" method="post" action="/login">
                            <fieldset>
                                ...
                                <div class="form-group">
                                 ...
                                 <!-- Page708 아래 5줄 소스 수정 코딩함. name 속성에 remember-me 추가해 주고, value 속성 있다면 삭제해 줍니다 -->
                                <div class="checkbox">
                                    <label>
                                ...
                                <!-- Change this to a button or input when using this as a form -->
                                 ...
                                 <!-- Page708 소스 코딩할 때 아래 1줄 소스 주석 처리함 -->
                                <!-- <a href="index.html" class="btn btn-lg btn-success btn-block">Login</a> -->
                                
                                <!-- Page708 소스 코딩할 때 아래 1줄 소스 코딩함 -->
                                <!--  
                            ...
                            <!-- Page708 input type의 hidden 태그는 ${_csrf.parameterName}로 처리합니다.
