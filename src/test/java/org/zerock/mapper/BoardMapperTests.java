...
//		board.setTitle("첫 번째로 작성하는 제목입니다.!");
//		board.setContent("첫 번째로 작성하는 제목입니다.!");
//		board.setWriter("장나라");
//		
//		mapper.insert(board);
//		
...
//		BoardVO board = new BoardVO();
//		board.setTitle("두 번째로 작성하는 제목입니다.!");
//		board.setContent("두 번째로 작성하는 제목입니다.!");
//		board.setWriter("김희선");
//		
...
//		log.info("삭제된 데이터의 개수는 " + mapper.delete(9L) + "개 입니다!");
//	}
	
//	@Test
//	public void testUpdate() {
//		BoardVO board = new BoardVO();
//		// testUpdate() 메서드에서 수정 처리 실행 전에 "존재하는 번호인지 확인"해봅니다.
//		board.setBno(4L);
